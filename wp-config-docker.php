...
/** MySQL hostname */
/**
 * If trying to access from outside the docker environment, i.e., not from a container,
 * you have to use 127.0.0.1 to connect to the db, in Adminer you would use mariadb
 * as it is a container.
*/
